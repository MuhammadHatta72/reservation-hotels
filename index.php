              ...
              >
                <div class="p-3" style="max-width: 700px">
                  ...
                  <h1 class="display-3 text-white mb-4 animated slideInDown">
                    Selamat Datang di <br /> <span class="text-primary">Guest House</span>
                  </h1>
                  <a
                    href="#about"
      ...
      <div class="container-xxl py-5" id="facilities">
        <div class="container">
          <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">
              Eksplore
              <span class="text-primary text-uppercase">Fasilitas</span>
              Kami
            </h1>
          </div>
          <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="rounded shadow overflow-hidden">
                <div class="position-relative">
                  <img
                    class="img-fluid"
                    src="assets/landing/img/fasilitas/dapur.jpeg"
                    alt=""
                  />
                </div>
                <div class="text-center p-4 mt-1">
                  <h5 class="fw-bold mb-0">Dapur</h5>
                  <small>Dapur Bersama</small>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="rounded shadow overflow-hidden">
                <div class="position-relative">
                  <img
                    class="img-fluid"
                    src="assets/landing/img/fasilitas/kamar1.jpeg"
                    alt=""
                  />
                </div>
                <div class="text-center p-4 mt-3">
                  <h5 class="fw-bold mb-0">Kamar</h5>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
              <div class="rounded shadow overflow-hidden">
                <div class="position-relative">
                  <img
                    class="img-fluid"
                    src="assets/landing/img/fasilitas/lemari.jpeg"
                    alt=""
                  />
                </div>
                <div class="text-center p-4 mt-3">
                  <h5 class="fw-bold mb-0">Lemari</h5>
                  <small>Lemari Pakaian</small>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="rounded shadow overflow-hidden">
                <div class="position-relative">
                  <img
                    class="img-fluid"
                    src="assets/landing/img/fasilitas/ruang_tamu.jpeg"
                    alt=""
                  />
                </div>
                <div class="text-center p-4 mt-1">
                  <h5 class="fw-bold mb-0">Ruang Tamu</h5>
                  <small>Ruang Tamu Bersama</small>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="rounded shadow overflow-hidden">
                <div class="position-relative">
                  <img
                    class="img-fluid"
                    src="assets/landing/img/fasilitas/represionis.jpeg"
                    alt=""
                  />
                </div>
                <div class="text-center p-4 mt-3">
                  <h5 class="fw-bold mb-0">Daftar Tamu</h5>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
              <div class="rounded shadow overflow-hidden">
                <div class="position-relative">
                  <img
                    class="img-fluid"
                    src="assets/landing/img/fasilitas/ruang_pertemuan.jpeg"
                    alt=""
                  />
                </div>
                <div class="text-center p-4 mt-3">
                  <h5 class="fw-bold mb-0">Ruang Pertemuan</h5>
                  <small>Ruang Pertemuan</small>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        <iframe class="position-relative rounded w-100 h-100"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.9930406645594!2d111.72276047508828!3d-6.770699866211127!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e770f5b81de2363%3A0xab1208b5d261f1cd!2sUPT%20Pelabuhan%20Perikanan%20Pantai%20Bulu!5e0!3m2!1sid!2sid!4v1705311093898!5m2!1sid!2sid"
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                          <div class="text-left wow fadeInUp" data-wow-delay="0.1s">
                              <h1 class="mt-5 mb-3"><span class="text-primary text-uppercase">Kontak</span> Kami</h1>
                          </div>
                          <p class="mt-3 mb-3">
